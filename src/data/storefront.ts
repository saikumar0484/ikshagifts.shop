...
export const customerReviews = [
  {
    ...
    quote:
      "The bouquet looked even more premium in person. The packaging made it feel truly gift-ready.",
    image: bouquet,
  },
  {
    name: "Harish S.",
    ...
    quote:
      "I wanted something memorable, not generic. The final piece felt personal and beautifully finished.",
    image: keychain,
  },
  {
    name: "Sravya K.",
    ...
    quote:
      "Every piece arrived neatly wrapped and the details looked thoughtful from start to finish.",
    image: bow,
  },
  {
    name: "Akhil P.",
    ...
    quote:
      "Packaging, message card, and product quality were all premium. It felt worth gifting immediately.",
    image: galleryThree,
  },
];
...
export const giftExperience = [
  {
    ...
    description:
      "Every order is packed in a clean, premium presentation that is ready to gift the moment it arrives.",
    image: galleryOne,
  },
  {
    title: "Thoughtful Wrapping",
    description:
      "Ribbon styling, note cards, and wrapping choices are planned around the occasion and the person receiving it.",
    image: galleryTwo,
  },
  {
